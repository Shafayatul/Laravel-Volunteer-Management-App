...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="{{ $errors->has('is_volunteer_limit') ? 'has-error' : ''}}">
            ...
            {{ Form::checkbox('is_volunteer_limit', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'is_volunteer_limit']) }}
        ...
        <div class="{{ $errors->has('is_call') ? 'has-error' : ''}}">
            {{ Form::checkbox('is_call', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'is_call']) }}
...
<div class="row">
    <div class="col-sm-3">
        {{ Form::checkbox('subject1', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject1']) }}
        {{Form::label("subject1", ucfirst("subject1")) }}<br>
    </div>
    <div class="col-sm-3">
        {{ Form::checkbox('subject2', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject2']) }}
        {{Form::label("subject2", ucfirst("subject2")) }}<br>
    </div>
    <div class="col-sm-3">
        {{ Form::checkbox('subject3', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject3']) }}
        {{Form::label("subject3", ucfirst("subject3")) }}<br>
    </div>
    <div class="col-sm-3">
        {{ Form::checkbox('subject4', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject4']) }}
        {{Form::label("subject4", ucfirst("subject4")) }}<br>
    </div>
</div>
<div class="row">
    <div class="col-sm-3">
        {{ Form::checkbox('subject5', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject5']) }}
        {{Form::label("subject5", ucfirst("subject5")) }}<br>
    </div>
    <div class="col-sm-3">
        {{ Form::checkbox('subject6', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject6']) }}
        {{Form::label("subject6", ucfirst("subject6")) }}<br>
    </div>
    <div class="col-sm-3">
        {{ Form::checkbox('subject7', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject7']) }}
        {{Form::label("subject7", ucfirst("subject7")) }}<br>
    </div>
    <div class="col-sm-3">
        {{ Form::checkbox('subject8', 1, false, ['class' => 'filled-in chk-col-deep-orange', 'id' => 'subject8']) }}
