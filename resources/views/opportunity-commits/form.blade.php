...
<div class="form-group {{ $errors->has('opportunity_id') ? 'has-error' : ''}}">
    ...
    {!! Form::text('opportunity_id', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    {!! $errors->first('opportunity_id', '<p class="help-block">:message</p>') !!}
</div>
