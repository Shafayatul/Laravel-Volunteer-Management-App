            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/tasks', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Project Id</th><th>Description</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($tasks as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->project_id }}</td><td>{{ $item->description }}</td>
                                        <td>
